...
class IngresarObjeto {
    ...
    interpretar(entorno) {
        const objetoDefinido = entorno.diccionarioObjetos.get(this.tipoObjeto);
        if (!objetoDefinido) {
            entorno.errores.push({ tipo: "Semántico", descripcion: `Tipo de objeto ${this.tipoObjeto} no definido` });
            return;
        }
        ...
        entorno.declarar(this.id, "OBJETO:" + this.tipoObjeto, atributosObjeto);
    }
}
